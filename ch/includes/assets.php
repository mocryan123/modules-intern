...
function ch_global_styles() {
    ...
    /* TOP NAV */
    .ch-burger-menu-btn { display: none; background: transparent; border: none; padding: 4px; cursor: pointer; color: var(--ch-text); flex-shrink: 0; outline: none; border-radius: var(--ch-radius-sm); transition: background 0.2s; }
    .ch-burger-menu-btn:hover { background: color-mix(in srgb, var(--ch-text) 10%, transparent); }
    .ch-top-nav {
        background: rgba(255, 255, 255, 0.88); border-bottom: 1px solid var(--ch-border);
        padding: 0 32px; height: 64px; transition: all 0.25s ease;
    ...
    .ch-top-nav-notifications { display: flex; align-items: center; }
    .ch-nav-label { display: inline; } /* hidden at 480px breakpoint */
    .ch-nav-link {
        display: inline-flex; align-items: center; gap: 6px;
        padding: 7px 16px; border-radius: var(--ch-radius);
        text-decoration: none; font-size: 13.5px; font-weight: 500;
        color: var(--ch-text-muted); transition: all 0.15s; height: 38px;
        letter-spacing: -0.1px;
    }
    .ch-nav-link:hover  { background: var(--ch-accent-light); color: var(--ch-accent); }
    .ch-nav-link.active {
        color: var(--ch-accent); font-weight: 600; position: relative;
    ...
    .ch-nav-link.active::after {
        ...
        width: 28px; height: 3px; background: var(--ch-accent); border-radius: 3px 3px 0 0;
    }
    ...
    @media (min-width: 781px) {
        ...
        .ch-user-bar::before {
            ...
            background: var(--ch-border); margin-right: 2px;
        }
    }
    .ch-icon-action-btn {
    ...
    .ch-avatar-btn {
        ...
        color: white; font-size: 13px; font-weight: 700; border: 2px solid transparent; cursor: pointer;
        display: inline-flex; align-items: center; justify-content: center;
        transition: transform 0.15s, box-shadow 0.15s, border-color 0.15s;
        box-shadow: 0 2px 8px rgba(255,117,81,0.25);
    }
    .ch-avatar-btn:hover { transform: scale(1.06); box-shadow: 0 4px 14px rgba(255,117,81,0.4); border-color: rgba(255,255,255,0.3); }
    .ch-avatar-btn-lg { width: 40px; height: 40px; font-size: 15px; flex-shrink: 0; }
    .ch-avatar-btn-inner,
    .ch-avatar-btn-inner-lg,
    .ch-composer-trigger-avatar-inner { width: 100%; height: 100%; border-radius: inherit; overflow: hidden; display: flex; align-items: center; justify-content: center; }
    .ch-avatar-img { width: 100%; height: 100%; object-fit: cover; display: block; border-radius: inherit; }
    .ch-avatar-fallback { display: inline-flex; align-items: center; justify-content: center; width: 100%; height: 100%; }
    ...
    .ch-dropdown-panel {
        ...
        min-width: 300px; max-width: 360px; z-index: 9999; overflow-x: hidden; overflow-y: auto;
    ...
    /* PAGE HEADER */
    .ch-page-header { display: flex; justify-content: space-between; align-items: flex-start; gap: 16px; margin-bottom: 22px; padding-bottom: 14px; border-bottom: 1px solid var(--ch-border-soft); }
    ...
    .ch-card {
        background: var(--ch-surface); border: 1px solid var(--ch-border);
        border-radius: var(--ch-radius-xl); overflow: hidden; margin-bottom: 24px;
         transition: transform 0.25s ease, box-shadow 0.25s ease;
    }
    .ch-card-header {
        display: flex; justify-content: space-between; align-items: center;
        padding: 14px 20px; border-bottom: 1px solid var(--ch-border-soft); background: color-mix(in srgb, var(--ch-surface) 82%, var(--ch-bg) 18%);
    }
    ...
    /* BUTTONS */
    .ch-btn { display: inline-flex; align-items: center; justify-content: center; gap: 8px; padding: 10px 22px; border-radius: 999px; font-size: 13.5px; font-weight: 700; font-family: var(--ch-font); border: none; cursor: pointer; transition: all 0.25s cubic-bezier(0.16, 1, 0.3, 1); text-decoration: none; white-space: nowrap; letter-spacing: 0.2px; }
    .ch-btn-primary   { background: linear-gradient(135deg, var(--ch-accent), var(--ch-accent-dark)); color: white; box-shadow: 0 4px 12px rgba(255,117,81,0.25); }
    .ch-btn-primary:hover { box-shadow: 0 8px 18px rgba(255,117,81,0.38); transform: translateY(-1.5px); }
    .ch-btn:active { transform: translateY(1px) scale(0.97) !important; box-shadow: none !important; }
    .ch-btn-secondary { background: var(--ch-surface); color: var(--ch-text); border: 1px solid var(--ch-border); box-shadow: var(--ch-shadow-sm); }
    .ch-btn-secondary:hover { background: var(--ch-bg); border-color: var(--ch-accent-mid); color: var(--ch-accent); transform: translateY(-1px); box-shadow: var(--ch-shadow); }
    ...
    /* FORM */
    .ch-input { width: 100%; padding: 16px; border: 1.5px solid var(--ch-border); border-radius: 14px; font-size: 14px; font-family: var(--ch-font); background: color-mix(in srgb, var(--ch-surface) 60%, var(--ch-bg) 40%); color: var(--ch-text); box-sizing: border-box; outline: none; transition: all 0.25s cubic-bezier(0.16, 1, 0.3, 1); box-shadow: inset 0 2px 6px rgba(17,24,39,0.015); letter-spacing: 0.1px; }
    .ch-input:focus { border-color: var(--ch-accent); box-shadow: 0 0 0 4px rgba(255,117,81,0.18), inset 0 2px 4px rgba(17,24,39,0.01); background: var(--ch-bg); transform: translateY(-1px); }
    ...
    /* MODAL */
    .ch-modal-overlay { position: fixed; inset: 0; background: rgba(26,26,46,0.45); display: flex; align-items: center; justify-content: center; z-index: 99999; padding: 20px; backdrop-filter: blur(8px); }
    .ch-modal { background: var(--ch-surface); border-radius: var(--ch-radius-xl); width: 100%; max-width: 490px; max-height: 90vh; overflow-y: auto; box-shadow: 0 28px 80px rgba(26,26,46,0.22); border: 1px solid color-mix(in srgb, var(--ch-border) 82%, transparent 18%); }
    ...
    .ch-composer-modal { max-width: 548px; max-height: min(88vh, 760px); border-radius: 12px; overflow: hidden; display: flex; flex-direction: column; }
    ...
    .ch-composer-body { padding: 14px 16px 8px; display: flex; flex-direction: column; gap: 10px; overflow-y: auto; min-height: 0; }
    ...
    .ch-composer-textarea { -webkit-text-fill-color: var(--ch-text); }
    ...
    /* Media upload area */
    .ch-composer-media-area { display: block; border: 2px dashed var(--ch-border); border-radius: 10px; cursor: pointer; transition: border-color 0.15s, background 0.15s; text-decoration: none; padding: 10px; }
    .ch-composer-media-area:hover { border-color: var(--ch-accent-mid); background: var(--ch-accent-light); }
    .ch-composer-media-inner { display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 4px; padding: 16px 12px; color: var(--ch-text-muted); min-height: 120px; }
    ...
    .ch-composer-media-area.has-media .ch-composer-media-inner { min-height: 56px; padding: 8px 10px 2px; gap: 2px; }
    .ch-composer-media-area.has-media .ch-composer-media-inner svg { width: 16px; height: 16px; }
    .ch-composer-media-area.has-media .ch-composer-media-inner span { font-size: 12px; }
    .ch-composer-media-area.has-media .ch-composer-media-sub { font-size: 10.5px !important; }
    .ch-composer-media-preview { display: grid; grid-template-columns: repeat(auto-fill, minmax(72px, 84px)); gap: 8px; margin-top: 8px; padding-top: 8px; border-top: 1px dashed var(--ch-border-soft); justify-content: flex-start; }
    .ch-composer-media-preview:empty { display: none; }
    .ch-composer-media-chip { position: relative; width: 84px; height: 84px; border-radius: 10px; overflow: hidden; border: 1px solid var(--ch-border); background: var(--ch-bg); box-shadow: 0 4px 12px rgba(17,24,39,0.08); }
    .ch-composer-media-chip img, .ch-composer-media-chip video { width: 100%; height: 100%; object-fit: cover; display: block; }
    .ch-composer-media-chip-audio { width: 100%; height: 100%; padding: 10px 8px; display: flex; flex-direction: column; justify-content: center; gap: 6px; color: var(--ch-text-muted); background: var(--ch-surface); }
    .ch-composer-media-chip-audio-name { font-size: 11px; line-height: 1.25; word-break: break-word; }
    .ch-composer-media-remove { position: absolute; top: 4px; right: 4px; width: 22px; height: 22px; border: none; border-radius: 999px; background: rgba(17,24,39,0.78); color: #fff; cursor: pointer; display: inline-flex; align-items: center; justify-content: center; font-size: 14px; line-height: 1; }
    .ch-composer-media-remove:hover { background: rgba(239,68,68,0.9); }
    .ch-confirm-modal { max-width: 420px; }
    .ch-confirm-copy { font-size: 14px; line-height: 1.65; color: var(--ch-text-muted); margin: 0; }
    .ch-confirm-actions { display: flex; justify-content: flex-end; gap: 10px; margin-top: 18px; flex-wrap: wrap; }
    .ch-warning-modal { max-width: 420px; }
    .ch-warning-copy { font-size: 14px; line-height: 1.65; color: var(--ch-text-muted); margin: 0; }
    .ch-warning-actions { display: flex; justify-content: flex-end; margin-top: 18px; }
    .ch-loading-modal { max-width: 320px; text-align: center; }
    .ch-loading-modal-body { padding: 28px 24px 24px; display: flex; flex-direction: column; align-items: center; gap: 14px; }
    ...
    .ch-loading-modal-title { margin: 0; font-size: 16px; font-weight: 700; color: var(--ch-text); }
    .ch-loading-modal-copy { margin: 0; font-size: 13px; line-height: 1.6; color: var(--ch-text-muted); }
    ...
    /* Scrollbars */
    * { scrollbar-width: thin; scrollbar-color: var(--ch-scroll-thumb) var(--ch-scroll-track); }
    *::-webkit-scrollbar { width: 10px; height: 10px; }
    *::-webkit-scrollbar-track { background: var(--ch-scroll-track); }
    *::-webkit-scrollbar-thumb { background: var(--ch-scroll-thumb); border-radius: 999px; border: 2px solid var(--ch-scroll-track); }
    *::-webkit-scrollbar-thumb:hover { background: var(--ch-scroll-thumb-hover); }
    ...
    .ch-onboarding-modal { max-width: 480px; overflow: hidden; }
    .ch-onboarding-progress { display: grid; grid-template-columns: repeat(3, 1fr); gap: 6px; margin-bottom: 18px; }
    .ch-onboarding-progress-bar { height: 6px; border-radius: 999px; background: var(--ch-border-soft); overflow: hidden; }
    .ch-onboarding-progress-bar span { display: block; width: 100%; height: 100%; transform: scaleX(0); transform-origin: left; background: linear-gradient(90deg, var(--ch-accent), var(--ch-accent-dark)); transition: transform 0.2s ease; }
    .ch-onboarding-progress-bar.is-active span,
    .ch-onboarding-progress-bar.is-done span { transform: scaleX(1); }
    .ch-onboarding-stage-label { font-size: 11px; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; color: var(--ch-text-subtle); margin-bottom: 8px; }
    .ch-onboarding-slide { display: none; }
    .ch-onboarding-slide.is-active { display: block; }
    .ch-onboarding-hero { display: flex; align-items: flex-start; gap: 14px; padding: 16px; border-radius: 16px; border: 1px solid var(--ch-border); background: linear-gradient(145deg, color-mix(in srgb, var(--ch-accent-light) 82%, var(--ch-surface) 18%), var(--ch-surface)); margin-bottom: 16px; }
    .ch-onboarding-hero-icon { width: 46px; height: 46px; border-radius: 14px; background: linear-gradient(135deg, var(--ch-accent), var(--ch-accent-dark)); color: #fff; display: inline-flex; align-items: center; justify-content: center; flex-shrink: 0; box-shadow: 0 12px 24px rgba(255,117,81,0.24); }
    .ch-onboarding-hero h4 { margin: 0 0 4px; font-size: 18px; line-height: 1.25; color: var(--ch-text); }
    .ch-onboarding-hero p { margin: 0; font-size: 13.5px; line-height: 1.65; color: var(--ch-text-muted); }
    .ch-onboarding-checklist { display: flex; flex-direction: column; gap: 10px; }
    .ch-onboarding-point { display: flex; gap: 10px; align-items: flex-start; padding: 11px 12px; border-radius: 12px; background: color-mix(in srgb, var(--ch-surface) 75%, var(--ch-bg) 25%); border: 1px solid var(--ch-border-soft); }
    .ch-onboarding-point strong { display: block; font-size: 13px; color: var(--ch-text); margin-bottom: 2px; }
    .ch-onboarding-point span { display: block; font-size: 12.5px; color: var(--ch-text-muted); line-height: 1.55; }
    .ch-onboarding-dot { width: 10px; height: 10px; border-radius: 999px; margin-top: 5px; background: linear-gradient(135deg, var(--ch-accent), var(--ch-accent-dark)); flex-shrink: 0; }
    .ch-onboarding-footer { display: flex; align-items: center; justify-content: space-between; gap: 10px; flex-wrap: wrap; }
    .ch-onboarding-footer-left,
    .ch-onboarding-footer-right { display: flex; align-items: center; gap: 8px; }
    ...
    /* POST CARDS */
    .ch-posts-list { display: flex; flex-direction: column; gap: 16px; }
    .ch-post-card { background: color-mix(in srgb, var(--ch-surface) 60%, var(--ch-bg) 40%); border: 1px solid var(--ch-border); border-radius: var(--ch-radius-xl); padding: 22px; display: flex; gap: 16px; transition: all 0.3s cubic-bezier(0.16, 1, 0.3, 1); position: relative;  }
    .ch-post-card:hover { box-shadow: var(--ch-shadow-md); border-color: var(--ch-accent); transform: translateY(-3px) scale(1.005); }
    ...
    .ch-post-title  { margin: 0 0 6px; font-size: 18px; font-weight: 700; line-height: 1.4; letter-spacing: -0.2px; color: inherit; }
    ...
    .ch-post-media-preview { display: grid; gap: 8px; margin: 8px 0 12px; }
    .ch-post-media-preview-feed { grid-template-columns: repeat(auto-fit, minmax(128px, 1fr)); }
    .ch-post-media-gallery { grid-auto-rows: minmax(120px, 1fr); }
    .ch-post-media-gallery-1 { grid-template-columns: 1fr; }
    .ch-post-media-gallery-2,
    .ch-post-media-gallery-4 { grid-template-columns: repeat(2, minmax(0, 1fr)); }
    .ch-post-media-gallery-3 { grid-template-columns: minmax(0, 1.35fr) minmax(0, 1fr); }
    .ch-post-media-gallery-3 .ch-post-media-thumb:first-child { grid-row: span 2; min-height: 248px; }
    .ch-post-media-gallery-4,
    .ch-post-media-gallery-more { grid-template-columns: repeat(2, minmax(0, 1fr)); }
    .ch-post-media-preview-post.ch-post-media-gallery-1 .ch-post-media-thumb { aspect-ratio: 1.45 / 1; max-height: 420px; }
    .ch-post-media-preview-feed.ch-post-media-gallery-1 .ch-post-media-thumb { aspect-ratio: 1.08 / 1; max-height: 320px; }
    .ch-post-media-thumb { display: block; overflow: hidden; border-radius: 12px; border: 1px solid var(--ch-border); background: color-mix(in srgb, var(--ch-surface) 72%, var(--ch-bg) 28%); min-height: 120px; aspect-ratio: 1.1 / 1; max-height: 240px; position: relative; }
    .ch-post-media-thumb-button { padding: 0; cursor: pointer; width: 100%; text-align: left; appearance: none; -webkit-appearance: none; }
    .ch-post-media-thumb-button:hover .ch-post-media-thumb-img { transform: scale(1.03); }
    .ch-post-media-thumb-img, .ch-post-media-thumb-video { width: 100%; height: 100%; min-height: 120px; max-height: 240px; object-fit: cover; display: block; transition: transform 0.2s ease; }
    .ch-post-media-more { position: absolute; inset: 0; display: flex; align-items: center; justify-content: center; background: rgba(15, 23, 42, 0.46); color: #fff; font-size: 24px; font-weight: 700; letter-spacing: -0.03em; }
    .ch-post-media-audio-wrap { border: 1px solid var(--ch-border); background: var(--ch-surface); border-radius: 12px; padding: 10px; }
    .ch-post-media-audio-inline { width: 100%; }
    .ch-post-media-preview-mixed { grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); }
    .ch-media-item { border-radius: var(--ch-radius); overflow: hidden; border: 1px solid var(--ch-border); background: color-mix(in srgb, var(--ch-bg) 90%, var(--ch-surface) 10%); display: flex; align-items: center; justify-content: center; }
    .ch-media-image { width: 100%; max-height: min(460px, 55vh); object-fit: contain; display: block; background: color-mix(in srgb, var(--ch-bg) 90%, var(--ch-surface) 10%); }
    .ch-media-video { width: 100%; max-height: min(460px, 55vh); object-fit: contain; display: block; background: color-mix(in srgb, var(--ch-bg) 90%, var(--ch-surface) 10%); }
    .ch-media-audio { width: 100%; display: block; }
    .ch-media-lightbox-overlay { position: fixed; inset: 0; background: rgba(15, 23, 42, 0.94); z-index: 100001; display: none; align-items: center; justify-content: center; padding: 20px; backdrop-filter: blur(8px); }
    .ch-media-lightbox { position: relative; width: min(96vw, 1120px); height: min(90vh, 820px); display: flex; align-items: center; justify-content: center; }
    .ch-media-lightbox-stage { width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; padding: 18px 56px; }
    .ch-media-lightbox-image { max-width: 100%; max-height: 100%; object-fit: contain; border-radius: 18px; box-shadow: 0 24px 60px rgba(0,0,0,0.36); image-rendering: auto; }
    .ch-media-lightbox-close,
    .ch-media-lightbox-nav { position: absolute; border: none; width: 46px; height: 46px; border-radius: 999px; background: rgba(255,255,255,0.12); color: #fff; display: inline-flex; align-items: center; justify-content: center; cursor: pointer; backdrop-filter: blur(12px); }
    .ch-media-lightbox-close { top: 8px; right: 8px; }
    .ch-media-lightbox-nav { top: 50%; transform: translateY(-50%); }
    .ch-media-lightbox-prev { left: 8px; }
    .ch-media-lightbox-next { right: 8px; }
    .ch-media-lightbox-close:hover,
    .ch-media-lightbox-nav:hover { background: rgba(255,255,255,0.2); }
    .ch-media-lightbox-counter { position: absolute; left: 50%; bottom: 8px; transform: translateX(-50%); padding: 8px 14px; border-radius: 999px; background: rgba(15,23,42,0.55); color: #fff; font-size: 12.5px; font-weight: 600; letter-spacing: 0.02em; }
    ...
    .ch-auth-form .ch-input { width: 100%; padding: 16px; font-size: 13.5px; border: 1px solid var(--ch-border); border-radius: var(--ch-radius); outline: none; transition: border 0.15s, box-shadow 0.15s; box-sizing: border-box; background: var(--ch-surface); color: var(--ch-text); }
    ...
    *, *::before, *::after {
    ...
    .ch-brand-logo { height: 28px; width: auto; max-width: 140px; object-fit: contain; display: block; flex-shrink: 0; }
        ...
        .ch-top-nav-logo { order: 1; }
        .ch-top-nav .ch-top-nav-notifications { order: 2; margin-left: auto; margin-right: 8px; }
        .ch-top-nav .ch-burger-menu-btn { display: flex; order: 3; margin-left: 0; }
        ...
        .ch-user-bar { display: none; position: absolute; top: calc(100% + 104px); left: 0; width: 100%; background: var(--ch-surface); padding: 6px 20px 24px; box-shadow: var(--ch-shadow-md); border-bottom: 1px solid var(--ch-border); border-radius: 0 0 20px 20px; flex-direction: column; gap: 10px; }
        .ch-user-bar .ch-btn { width: 100%; }
        .ch-nav-links.ch-nav-open, .ch-user-bar.ch-nav-open, .ch-nav.ch-nav-open { display: flex; animation: ch-fade-up 0.2s ease; }
        .ch-nav-link { width: 100%; padding: 12px; font-size: 15px; border-radius: var(--ch-radius); }
        .ch-dark .ch-nav-links, .ch-dark .ch-user-bar { background: var(--ch-surface); border-color: var(--ch-border-soft); }
        ...
        .ch-post-card { flex-direction: column; padding: 18px 16px; gap: 12px; }
        .ch-post-vote-col { flex-direction: row; align-items: center; gap: 8px; min-width: 0; padding-top: 0; }
        .ch-post-time { margin-left: 0; width: 100%; }
        .ch-post-media-preview-feed { grid-template-columns: repeat(2, minmax(0, 1fr)); }
        .ch-post-media-gallery-3 { grid-template-columns: repeat(2, minmax(0, 1fr)); }
        .ch-post-media-gallery-3 .ch-post-media-thumb:first-child { grid-row: auto; min-height: 120px; }
        ...
        .ch-mf-profile-info { width: 100%; text-align: center; }
        .ch-mf-name-row { justify-content: center; }
        ...
        .ch-auth-card { padding: 32px 24px; border-radius: 20px; }
        ...
        .ch-onboarding-hero { flex-direction: column; }
        .ch-onboarding-footer,
        .ch-onboarding-footer-left,
        .ch-onboarding-footer-right { width: 100%; }
        .ch-onboarding-footer-left .ch-btn,
        .ch-onboarding-footer-right .ch-btn { flex: 1; justify-content: center; }
    ...
    @media (max-width: 480px) {
        ...
        .ch-post-media-preview-feed { grid-template-columns: 1fr; }
        .ch-post-media-gallery-2,
        .ch-post-media-gallery-3,
        .ch-post-media-gallery-4,
        .ch-post-media-gallery-more { grid-template-columns: 1fr 1fr; }
        .ch-post-media-preview-post.ch-post-media-gallery-1 .ch-post-media-thumb,
        .ch-post-media-preview-feed.ch-post-media-gallery-1 .ch-post-media-thumb { aspect-ratio: 1.1 / 1; max-height: 280px; }
        ...
        .ch-composer-media-preview { grid-template-columns: repeat(auto-fill, minmax(64px, 72px)); }
        .ch-composer-media-chip { width: 72px; height: 72px; }
        .ch-media-lightbox-overlay { padding: 12px; }
        .ch-media-lightbox { width: 100%; height: min(82vh, 560px); }
        .ch-media-lightbox-stage { padding: 12px 36px 26px; }
        .ch-media-lightbox-close,
        .ch-media-lightbox-nav { width: 40px; height: 40px; }
        .ch-media-lightbox-prev { left: 0; }
        .ch-media-lightbox-next { right: 0; }
        .ch-media-lightbox-counter { bottom: 0; }
    ...
    .ch-dashboard-wrap.ch-dark { background: var(--ch-bg); color: var(--ch-text); }
    .ch-dark .ch-top-nav { background: rgba(18, 18, 20, 0.75); backdrop-filter: blur(18px); -webkit-backdrop-filter: blur(18px); border-bottom-color: var(--ch-border-soft); }
    .ch-dashboard-wrap.ch-dark .ch-top-nav { background: rgba(18, 18, 20, 0.75); backdrop-filter: blur(18px); -webkit-backdrop-filter: blur(18px); border-bottom-color: var(--ch-border-soft); }
    .ch-dark .ch-post-card:hover { border-color: var(--ch-accent-mid); }
    .ch-dashboard-wrap.ch-dark .ch-post-card:hover { border-color: var(--ch-accent-mid); }
    .ch-dark .ch-welcome-card { background: var(--ch-surface); }
    .ch-dashboard-wrap.ch-dark .ch-welcome-card { background: var(--ch-surface); }
    .ch-dark .ch-pop-cat-count { background: var(--ch-bg); border-color: var(--ch-border); }
    .ch-dashboard-wrap.ch-dark .ch-pop-cat-count { background: var(--ch-bg); border-color: var(--ch-border); }
    .ch-dark .bntm-notice-success { background: #064e3b; color: #6ee7b7; }
    .ch-dark .bntm-notice-error   { background: #7f1d1d; color: #fca5a5; }
    .ch-dashboard-wrap.ch-dark .bntm-notice-success { background: #064e3b; color: #6ee7b7; }
    .ch-dashboard-wrap.ch-dark .bntm-notice-error   { background: #7f1d1d; color: #fca5a5; }
    ...
    .ch-dashboard-wrap.ch-dark .ch-announcement-card { background: linear-gradient(135deg, #1f1a08, #2a2210); border-color: #5c3d0a; }
    .ch-dashboard-wrap.ch-dark .ch-announcement-card::before { background: linear-gradient(90deg, #b45309, #92400e); }
    ...
    .ch-dashboard-wrap.ch-dark .ch-announcement-content { color: #e5c97a; }

    /* TABLE — dark mode fix: td has no background set so it bleeds white from the card */
    .ch-dark .bntm-table tr td,
    .ch-dashboard-wrap.ch-dark .bntm-table tr td { background: var(--ch-surface); color: var(--ch-text); }
    .ch-dark .bntm-table tr:hover td,
    .ch-dashboard-wrap.ch-dark .bntm-table tr:hover td { background: var(--ch-bg); }
    .ch-dark .bntm-table th,
    .ch-dashboard-wrap.ch-dark .bntm-table th { background: var(--ch-bg); color: var(--ch-text-subtle); border-bottom-color: var(--ch-border); }
    .ch-dark .bntm-table td,
    .ch-dashboard-wrap.ch-dark .bntm-table td { border-bottom-color: var(--ch-border-soft); }

    /* Status badges — dark mode */
    .ch-dark .ch-status-active,    .ch-dashboard-wrap.ch-dark .ch-status-active    { background: #064e3b; color: #6ee7b7; }
    .ch-dark .ch-status-removed,   .ch-dashboard-wrap.ch-dark .ch-status-removed   { background: #7f1d1d; color: #fca5a5; }
    .ch-dark .ch-status-pending,   .ch-dashboard-wrap.ch-dark .ch-status-pending   { background: #451a03; color: #fcd34d; }
    .ch-dark .ch-status-suspended, .ch-dashboard-wrap.ch-dark .ch-status-suspended { background: #431407; color: #fdba74; }
    .ch-dark .ch-status-banned,    .ch-dashboard-wrap.ch-dark .ch-status-banned    { background: #7f1d1d; color: #fca5a5; }
    .ch-dark .ch-status-reviewed,  .ch-dashboard-wrap.ch-dark .ch-status-reviewed  { background: #1e3a5f; color: #93c5fd; }
    .ch-dark .ch-status-resolved,  .ch-dashboard-wrap.ch-dark .ch-status-resolved  { background: #064e3b; color: #6ee7b7; }
    .ch-dark .ch-status-archived,  .ch-dashboard-wrap.ch-dark .ch-status-archived  { background: var(--ch-bg); color: var(--ch-text-muted); }
    .ch-dark .ch-status-dismissed, .ch-dashboard-wrap.ch-dark .ch-status-dismissed { background: var(--ch-bg); color: var(--ch-text-muted); }

    /* Announcement admin table — JS-rendered rows use hardcoded colors */
    .ch-dark #ch-ann-tbody td,
    .ch-dashboard-wrap.ch-dark #ch-ann-tbody td { background: var(--ch-surface); color: var(--ch-text); }
    .ch-dark #ch-ann-tbody tr:hover td,
    .ch-dashboard-wrap.ch-dark #ch-ann-tbody tr:hover td { background: var(--ch-bg); }
    .ch-dark #ch-ann-tbody [style*="color:#111827"],
    .ch-dashboard-wrap.ch-dark #ch-ann-tbody [style*="color:#111827"] { color: var(--ch-text) !important; }
    .ch-dark #ch-ann-tbody [style*="color:#9ca3af"],
    .ch-dashboard-wrap.ch-dark #ch-ann-tbody [style*="color:#9ca3af"] { color: var(--ch-text-subtle) !important; }

    /* Button variants — dark mode */
    .ch-dark .ch-btn-secondary,
    .ch-dashboard-wrap.ch-dark .ch-btn-secondary { background: var(--ch-bg); color: var(--ch-text); border-color: var(--ch-border); }
    .ch-dark .ch-btn-secondary:hover,
    .ch-dashboard-wrap.ch-dark .ch-btn-secondary:hover { background: var(--ch-accent-light); border-color: var(--ch-accent-mid); color: var(--ch-accent); }
    .ch-dark .ch-btn-warning,
    .ch-dashboard-wrap.ch-dark .ch-btn-warning { background: #451a03; color: #fcd34d; }
    .ch-dark .ch-btn-warning:hover,
    .ch-dashboard-wrap.ch-dark .ch-btn-warning:hover { background: #78350f; }
    .ch-dark .ch-btn-success,
    .ch-dashboard-wrap.ch-dark .ch-btn-success { background: #064e3b; color: #6ee7b7; }
    .ch-dark .ch-btn-success:hover,
    .ch-dashboard-wrap.ch-dark .ch-btn-success:hover { background: #065f46; }

    /* Filter buttons — dark mode */
    .ch-dark .ch-filter-btn,
    .ch-dashboard-wrap.ch-dark .ch-filter-btn { background: var(--ch-surface); color: var(--ch-text-muted); border-color: var(--ch-border); }
    .ch-dark .ch-filter-btn:hover,
    .ch-dashboard-wrap.ch-dark .ch-filter-btn:hover { background: var(--ch-accent-light); border-color: var(--ch-accent-mid); color: var(--ch-accent); }
    .ch-dark .ch-filter-btn.active,
    .ch-dashboard-wrap.ch-dark .ch-filter-btn.active { background: var(--ch-accent-light); color: var(--ch-accent); border-color: var(--ch-accent-mid); }

    /* Notification unread item — dark mode */
    .ch-dark .ch-notification-item.unread,
    .ch-dashboard-wrap.ch-dark .ch-notification-item.unread { background: color-mix(in srgb, var(--ch-accent) 10%, var(--ch-surface)); }
    .ch-dark .ch-notification-item.unread:hover,
    .ch-dashboard-wrap.ch-dark .ch-notification-item.unread:hover { background: color-mix(in srgb, var(--ch-accent) 15%, var(--ch-surface)); }
    .ch-dark .ch-notification-icon.type-reply,
    .ch-dashboard-wrap.ch-dark .ch-notification-icon.type-reply        { background: #2e1065; color: #a78bfa; }
    .ch-dark .ch-notification-icon.type-mention,
    .ch-dashboard-wrap.ch-dark .ch-notification-icon.type-mention      { background: #451a03; color: #fbbf24; }
    .ch-dark .ch-notification-icon.type-vote,
    .ch-dashboard-wrap.ch-dark .ch-notification-icon.type-vote         { background: #052e16; color: #4ade80; }
    .ch-dark .ch-notification-icon.type-announcement,
    .ch-dashboard-wrap.ch-dark .ch-notification-icon.type-announcement { background: #1e3a5f; color: #60a5fa; }
    .ch-dark .ch-notification-icon.type-report_resolved,
    .ch-dashboard-wrap.ch-dark .ch-notification-icon.type-report_resolved { background: #4a044e; color: #f472b6; }

    /* Dropdown danger hover — dark mode */
    .ch-dark .ch-dropdown-item-danger:hover,
    .ch-dashboard-wrap.ch-dark .ch-dropdown-item-danger:hover { background: #3b0a0a; color: #f87171; }

    /* Stat alert card — dark mode */
    .ch-dark .ch-stat-card.ch-stat-alert,
    .ch-dashboard-wrap.ch-dark .ch-stat-card.ch-stat-alert { border-color: #7f1d1d; background: #1a0a0a; }
    ...
    .ch-dashboard-wrap.ch-dark .ch-select-sm { background: var(--ch-surface); color: var(--ch-text); border-color: var(--ch-border); }
    .ch-dashboard-wrap.ch-dark select option { background: var(--ch-surface); color: var(--ch-text); }

    /* Sidebar widgets on feed */
    .ch-dark .ch-sidebar-widget,
    .ch-dashboard-wrap.ch-dark .ch-sidebar-widget { background: var(--ch-surface); border-color: var(--ch-border); }
    ...
    .ch-dashboard-wrap.ch-dark .bntm-notice-warning { background: #451a03; color: #fcd34d; border-left-color: #f59e0b; }
    ...
    .ch-dashboard-wrap.ch-dark .ch-stat-item { background: var(--ch-bg); border-color: var(--ch-border); color: var(--ch-text); }

    /* ── DARK MODE: MODAL ────────────────────────────────────────── */
    .ch-dark .ch-modal,
    .ch-dashboard-wrap.ch-dark .ch-modal { background: var(--ch-surface); }
    .ch-dark .ch-modal-header,
    .ch-dashboard-wrap.ch-dark .ch-modal-header { border-bottom-color: var(--ch-border-soft); }
    .ch-dark .ch-modal-footer,
    .ch-dashboard-wrap.ch-dark .ch-modal-footer { border-top-color: var(--ch-border-soft); }
    ...
    .ch-dark .ch-nav-link,
    .ch-dashboard-wrap.ch-dark .ch-nav-link { color: var(--ch-text-muted); }
    .ch-dark .ch-icon-action-btn,
    .ch-dashboard-wrap.ch-dark .ch-icon-action-btn { background: var(--ch-surface); border-color: var(--ch-border); color: var(--ch-text-muted); }
    /* Notification badge border matches dark nav */
    .ch-dark .ch-notification-badge,
    .ch-dashboard-wrap.ch-dark .ch-notification-badge { border-color: var(--ch-surface); }

    /* ── DARK MODE: ADMIN SIDEBAR & MAIN CONTENT ─────────────────── */
    .ch-dashboard-wrap.ch-dark .ch-sidebar { background: var(--ch-surface); border-right-color: var(--ch-border); }
    .ch-dashboard-wrap.ch-dark .ch-nav-item { color: var(--ch-text-muted); }
    .ch-dashboard-wrap.ch-dark .ch-nav-item:hover { background: var(--ch-accent-light); color: var(--ch-accent); }
    .ch-dashboard-wrap.ch-dark .ch-nav-item.active { background: var(--ch-accent-light); color: var(--ch-accent); }
    .ch-dashboard-wrap.ch-dark .ch-main-content { background: linear-gradient(180deg, color-mix(in srgb, var(--ch-bg) 94%, var(--ch-accent-light) 6%) 0%, var(--ch-bg) 180px); }
    .ch-dashboard-wrap.ch-dark .ch-page-header { border-bottom-color: var(--ch-border); }
    .ch-dashboard-wrap.ch-dark .ch-card { background: var(--ch-surface); border-color: var(--ch-border); }
    .ch-dashboard-wrap.ch-dark .ch-stat-card { background: var(--ch-surface); border-color: var(--ch-border); }
    .ch-dashboard-wrap.ch-dark .ch-stat-num { color: var(--ch-text); }
    .ch-dashboard-wrap.ch-dark .ch-stat-label { color: var(--ch-text-muted); }
    .ch-dashboard-wrap.ch-dark .ch-section-title { color: var(--ch-text); }
    .ch-dashboard-wrap.ch-dark input,
    .ch-dashboard-wrap.ch-dark textarea { background: var(--ch-bg); color: var(--ch-text); border-color: var(--ch-border); }
    .ch-dashboard-wrap.ch-dark .ch-input { background: var(--ch-bg); color: var(--ch-text); border-color: var(--ch-border); }
    ...
    @media (max-width: 780px) {
        .ch-feed-sidebar, .ch-guest-sidebar {
    ...
    @media (max-width: 780px) {
        body.ch-drawer-locked { overflow: hidden; }
        .ch-mobile-drawer-wrap {
            position: fixed; top: 0; right: 0; bottom: 0; width: 280px; max-width: 85vw;
            background: var(--ch-surface); z-index: 99999;
            transform: translateX(100%); transition: transform 0.3s cubic-bezier(0.4, 0, 0.2, 1);
            display: flex !important; flex-direction: column; padding: 24px 20px;
            box-shadow: -10px 0 40px rgba(0,0,0,0.1);
        }
        .ch-dark .ch-mobile-drawer-wrap { box-shadow: -10px 0 40px rgba(0,0,0,0.6); border-left: 1px solid var(--ch-border-soft); }
        .ch-mobile-drawer-wrap.ch-nav-open { transform: translateX(0); }
        ...
        .ch-mobile-drawer-wrap .ch-user-bar {
            ...
            width: 100% !important; background: transparent !important; box-shadow: none !important;
            border-bottom: none !important; padding: 0 !important; gap: 4px; margin-top: 32px;
        }
        ...
        .ch-mobile-drawer-wrap .ch-nav-label { display: inline !important; }
        .ch-mobile-drawer-wrap .ch-nav-link svg { width: 20px; height: 20px; }
        .ch-mobile-drawer-wrap .ch-nav-link.active {
            background: var(--ch-accent-light);
            color: var(--ch-accent);
        }
        .ch-mobile-drawer-wrap .ch-nav-link.active::after { display: none; }
        .ch-mobile-drawer-wrap .ch-user-bar { 
            flex-direction: row; flex-wrap: wrap; align-items: center; justify-content: flex-start; 
            gap: 16px; margin-top: auto; padding-top: 24px !important; border-top: 1px solid var(--ch-border-soft) !important; border-radius: 0;
        }
        .ch-mobile-drawer-wrap .ch-user-bar .ch-btn { width: 100%; flex: 1; min-width: 100px; }
        .ch-top-drawer-close { 
            position: absolute; top: 16px; left: 16px; background: none; border: none; 
            font-size: 28px; color: var(--ch-text-muted); cursor: pointer; padding: 4px; display: flex;
        }
        .ch-top-drawer-close:hover { color: var(--ch-text); }
        
        .ch-menu-backdrop {
            position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.4); z-index: 99998;
            opacity: 0; pointer-events: none; transition: opacity 0.3s ease; backdrop-filter: blur(4px); -webkit-backdrop-filter: blur(4px);
        }
        .ch-menu-backdrop.ch-backdrop-visible { opacity: 1; pointer-events: auto; }
    }
    
    @media (min-width: 781px) {
        .ch-mobile-drawer-wrap { display: contents; }
        .ch-top-drawer-close { display: none !important; }
    }
