            ...
            <div class="ch-feed-wrap">
                ...
                <main class="ch-feed-main">
                 ...
                 ORDER BY post_count DESC LIMIT 3"
                                    ...
                                    <div class="ch-post-body">
                                        ...
                                        <div class="ch-post-actions-row">
                                            ...
                                            <?php if ($user_id): ?>
                                                ...
                                                <?php endif; ?>
                                            <?php endif; ?>
                                            <button class="ch-post-action ch-share-btn"
                                                onclick="chOpenFeedShareModal('<?php echo esc_url(get_permalink() . '?view_post=' . $post->rand_id); ?>', '<?php echo esc_js($post->title); ?>')">
                                                <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                                    stroke-width="2">
                    ...
                    <div id="ch-modal-share-feed-post" class="ch-modal-overlay" style="display:none"
                        data-share-url="" data-share-title="">
                        <div class="ch-modal" style="max-width:420px;">
                            <div class="ch-modal-header">
                                <h3>Share this post</h3>
                                <button class="ch-modal-close" type="button" onclick="chCloseModal('ch-modal-share-feed-post')"
                                    aria-label="Close">&times;</button>
                            </div>
                            <div class="ch-modal-body" style="display:grid;gap:8px;">
                                <button class="ch-share-option"
                                    onclick="chShareFeedPost('twitter')">
                                ...
                                <button class="ch-share-option"
                                    onclick="chShareFeedPost('facebook')">
                                    <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                ...
                                <button class="ch-share-option"
                                    onclick="chShareFeedPost('linkedin')">
                                    <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                                        <path
