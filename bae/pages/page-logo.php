...
/* ── REAL-TIME PREVIEW (fires on every control change, no save needed) ── */
var _rt=null;
function sched(){clearTimeout(_rt);_rt=setTimeout(renderPreview,180);}

function renderPreview(){
    var url=el('ls-logo-url').value;
    /* image mode — swap instantly from cached img tag */
    if(url){
...
/* ── CONTROLS — every change triggers real-time preview ── */
