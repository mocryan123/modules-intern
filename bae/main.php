...
function bae_wizard_static_palettes() {
    return [
        [ 'name' => 'Bold',    'primary' => '#6d28d9', 'secondary' => '#2d1066', 'accent' => '#ec4899', 'personality' => 'Bold, premium, innovative',        'reason' => 'Strong contrast and vibrant energy make this a confident fit for brands that want to stand out.' ],
...
function bae_wizard_shortcode($user_id) {
    ...
    .bae-wiz-orb-1 { width: 520px; height: 520px; background: radial-gradient(circle, rgba(109,40,217,0.55) 0%, transparent 70%); top: -120px; left: -100px; }
    .bae-wiz-orb-2 { width: 420px; height: 420px; background: radial-gradient(circle, rgba(236,72,153,0.45) 0%, transparent 70%); bottom: -80px; right: -60px; }
    .bae-wiz-orb-3 { width: 300px; height: 300px; background: radial-gradient(circle, rgba(139,92,246,0.35) 0%, transparent 70%); top: 40%; left: 60%; }
    .bae-wiz-orb-4 { width: 250px; height: 250px; background: radial-gradient(circle, rgba(236,72,153,0.3) 0%, transparent 70%); top: 20%; right: 25%; }
    /* ── WIZ TOP BUTTONS ── */
    .bae-wiz-top-actions {
    ...
    .bae-wiz-skip:hover { color: #ede9ff; border-color: rgba(139,92,246,0.4); background: rgba(139,92,246,0.1); }
    .bae-wiz-token-btn {
    ...
    .bae-wiz-token-btn:hover { border-color: rgba(139,92,246,0.8); background: linear-gradient(135deg, rgba(109,40,217,0.55), rgba(139,92,246,0.45)); box-shadow: 0 4px 18px rgba(109,40,217,0.35); }
    /* ── TOKEN MODAL ── */
    ...
    .bae-wiz-token-modal {
        background: #1c1c26; border: 1px solid rgba(139,92,246,0.25);
    ...
    .bae-wiz-token-input:focus { border-color: #8b5cf6; box-shadow: 0 0 0 3px rgba(139,92,246,0.15); }
    ...
    .bae-wiz-token-submit {
        width: 100%; background: linear-gradient(135deg, #6d28d9, #8b5cf6); color: white;
    ...
    .bae-wiz-token-submit:hover { transform: translateY(-1px); box-shadow: 0 12px 32px rgba(109,40,217,0.5); }
            ...
            <div class="bae-wiz-token-modal">
                ...
                <div class="bae-wiz-token-modal-body">
                    ...
                    <div class="bae-wiz-token-input-wrap">
                        <input type="text" class="bae-wiz-token-input" id="bae-wiz-token-field" placeholder="e.g. BAE-XXXX-XXXX" autocomplete="off" maxlength="20">
                    </div>
...
header('Expires: Wed, 11 Jan 1984 05:00:00 GMT');
    ...
    <div class="bae-wrap" id="bae-wrap" style="opacity:0;transition:opacity 0.25s ease;">
        ...
        .bae-page-loader {
            ...
            background:
                ...
                radial-gradient(circle at 82% 14%, rgba(236,72,153,.12), transparent 28%),
        ...
        .bae-page-loader.bae-light {
            background:
                radial-gradient(circle at 18% 18%, rgba(139,92,246,.14), transparent 34%),
        ...
        <div class="bae-header">
            ...
            ?>
            <!-- 7-item header nav -->
            <nav class="bae-headnav" id="bae-headnav">
                ...
                <button type="button" class="<?php echo $nav_cls; ?>"
                    ...
                    <span class="bae-hn-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><?php echo $tab['icon']; ?></svg>
                ...
                <?php else: ?>
                <a href="<?php echo esc_url($base_url . '?tab=' . $slug); ?>" class="<?php echo $nav_cls; ?>">
                    <span class="bae-hn-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><?php echo $tab['icon']; ?></svg>
                    </span>
                    <span class="bae-hn-label"><?php echo esc_html($tab['label']); ?></span>
    ...
    .bae-dash-hero {
        ...
        border-bottom: 1px solid var(--border);
        background:
            radial-gradient(circle at 0% 0%, rgba(139,92,246,.12), transparent 28%),
            var(--bg-2);
        transition: background 0.5s, border-color 0.5s;
    }
    .bae-wrap.bae-light .bae-dash-hero {
        background:
            radial-gradient(circle at 0% 0%, rgba(139,92,246,.06), transparent 28%),
            var(--surface);
        border-bottom: 1px solid var(--border);
    }
    .bae-dash-user {
    ...
    .bae-lock-modal-header {
        ...
        background: linear-gradient(135deg, rgba(109,40,217,0.1), rgba(236,72,153,0.05));
    }
    ...
    @media (max-width: 768px) {
        .bae-hn-label { display: none; }
        .bae-hn-item { padding: 8px 10px; }
        .bae-headnav { gap: 0; }
    }
    @media (max-width: 480px) {
        .bae-hn-item { padding: 7px 8px; }
    }
    ...
    /* Old stepper rules — kept minimal for any legacy references */
...
#bae-card-social_kit::after {
    ...
    .bae-preview-tab-btn.active { color: var(--text); background: rgba(139,92,246,.12); }
    ...
    @media (max-width: 680px) {
        ...
        /* headnav mobile: icons only, labels hidden via headnav CSS */
    }
    </style>
    ...
    <div class="bae-card bae-profile-form-col">
        ...
        <div class="bae-bento-card span-12">
            ...
            <div class="bae-logo-studio-grid">
                ...
                <div id="bae-logo-css-builder-panel" style="<?php echo !empty($p['logo_url']) ? 'display:none;' : ''; ?>transition:opacity .3s;"><?php // hidden when uploaded logo exists ?>
                    <div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;">
    ...
    <div class="bae-preview-panel" id="bae-preview-panel" style="display:none;">
        ...
        <div class="bae-preview-panel-content">
            ...
            <div id="bae-live-preview-loading" style="display:none;position:absolute;inset:0;background:var(--bg-2);display:flex;align-items:center;justify-content:center;border-radius:12px;">
                <div style="width:24px;height:24px;border:2px solid rgba(139,92,246,0.2);border-top-color:#8b5cf6;border-radius:50%;animation:bae-spin 0.8s linear infinite;"></div>
            </div>
        </div>
    </div>
                ...
                .then(function(json) {
                    ...
                    if (json.success) {
                        ...
                        msg.innerHTML = '<div class="bae-notice bae-notice-success" style="display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;">' +
                            ...
                            '<button type="button" id="bae-resync-btn" style="background:rgba(139,92,246,.15);border:1px solid rgba(139,92,246,.3);border-radius:8px;padding:5px 12px;font-size:12px;font-weight:700;color:var(--brand-soft);cursor:pointer;font-family:\'Geist\',sans-serif;white-space:nowrap;flex-shrink:0;" onclick="baeResyncAllAssets()">' +
                ...
                .then(function(j){
                    ...
                    if (issues.length) {
                        html += '<div style="margin-top:16px;padding-top:14px;border-top:1px solid var(--border);display:flex;align-items:center;gap:10px;flex-wrap:wrap;">' +
                            '<button id="bae-autofix-btn" style="display:inline-flex;align-items:center;gap:7px;background:linear-gradient(135deg,#6d28d9,#8b5cf6);color:white;border:none;border-radius:10px;padding:10px 18px;font-size:13px;font-weight:700;font-family:\'Geist\',sans-serif;cursor:pointer;">' +
    ...
    ">
        <div style="flex:1;min-width:220px;">
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:8px;">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8b5cf6" stroke-width="2"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>
                <strong style="font-size:15px;color:var(--text);">Save your brand work</strong>
                <span style="background:rgba(139,92,246,.15);color:#8b5cf6;font-size:10px;font-weight:700;letter-spacing:.08em;padding:3px 8px;border-radius:20px;text-transform:uppercase;">Free</span>
            </div>
        ...
        <div id="bae-claim-form" style="display:flex;flex-direction:column;gap:10px;min-width:260px;">
            <button id="bae-claim-btn" onclick="baeClaim()"
                style="background:linear-gradient(135deg,#6d28d9,#8b5cf6);color:white;border:none;border-radius:12px;padding:13px 24px;font-size:14px;font-weight:700;font-family:'Geist',sans-serif;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;transition:all .2s;box-shadow:0 6px 20px rgba(109,40,217,.35);">
            ...
            <p style="font-size:11px;color:var(--text-3);text-align:center;margin:0;">Already have a ticket? <a href="#" onclick="baeClaim(document.getElementById('bae-existing-ticket').value);return false;" style="color:#8b5cf6;text-decoration:none;">Enter it below</a></p>
...
function bae_home_dashboard($user_id, $profile) {
    ...
    $tools = [
        ...
        ['slug'=>'assets',     'icon'=>'<rect width="8" height="8" x="3" y="3" rx="1"/><rect width="8" height="5" x="13" y="3" rx="1"/><rect width="8" height="8" x="13" y="12" rx="1"/><rect width="8" height="5" x="3" y="15" rx="1"/>', 'label'=>'Asset Generator', 'desc'=>$asset_count.' assets generated',    'color'=>'#ec4899'],
    ...
    <div class="bae-dash-shell">
        ...
        <div class="bae-dash-tools">
            ...
            <a href="<?php echo esc_url($base . '?tab=' . $t['slug']); ?>" class="bae-dash-card">
                ...
                <svg class="bae-dash-card-arrow" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
            </a>
            <?php endforeach; ?>
        </div>
